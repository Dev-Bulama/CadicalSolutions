...
export  function Navbar() {
  return (
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur border-b border-[#e4eaf2] h-[68px] flex items-center justify-between px-6 md:px-12">
        <div className="flex items-center gap-3">
           <Image
                  ...
                  />
          {/* <div className="w-9 h-9 bg-[#1565C0] rounded-lg flex items-center justify-center text-white font-bold text-lg font-serif">C</div> */}
          <div className="leading-tight">
            <div className="text-[#1565C0] text-sm font-semibold">Cadical Solutions</div>
            <div className="text-[10px] text-[#6b7c93] font-light">Health is Wealth</div>
          </div>
        </div>
        ...
        <div className="hidden md:flex gap-3">
          <button className="border border-[#1565C0] text-[#1565C0] px-4 py-2 rounded text-sm font-semibold hover:bg-[#1565C0] hover:text-white">Institutional Portal</button>
          <button className="bg-[#1565C0] text-white px-4 py-2 rounded text-sm font-semibold hover:bg-[#0d47a1]">Shop Now</button>
        </div>
      </nav>
  )
}
