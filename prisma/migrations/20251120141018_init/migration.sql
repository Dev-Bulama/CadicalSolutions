-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'CLINICIAN');

-- CreateEnum
CREATE TYPE "ServiceCategory" AS ENUM ('CONSULTATIONS', 'PHARMACEUTICALS', 'SURGICAL_EQUIPMENT', 'DIAGNOSTICS', 'REHABILITATION', 'EMERGENCY', 'COSMETICS', 'REFERRALS');
...
-- CreateIndex
CREATE UNIQUE INDEX "clinician_licenseNumber_key" ON "clinician"("licenseNumber");
